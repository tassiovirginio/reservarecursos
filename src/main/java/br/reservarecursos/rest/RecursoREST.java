 ...
 */
@Component
@ResourcePath("rest/recursos")
public class RecursoREST extends RestGeneric<AmbienteBusiness, Ambiente> {
    ...
    public Ambiente create(@RequestBody Ambiente obj) {
        business.save(obj);
        return obj;
    }
