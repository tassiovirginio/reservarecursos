 ...
 */
public class LinkModel extends Panel {

    public LinkModel(String id, final Usuario usuario, final Ambiente ambiente,
                     final Horario horario, final LocalDate data, final Integer diaSemana, final BasePage page) {
        super(id);

        final ReservarModal modal = new ReservarModal("modal", usuario, ambiente, horario, data, diaSemana, page);
        add(modal);
